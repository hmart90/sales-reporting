CREATE PROCEDURE [dbo].[GetExcelSheets]
...
BEGIN
	...
	TRUNCATE TABLE dbo.TempExcelSheet
	INSERT INTO dbo.TempExcelSheet
		(SheetName)
	SELECT RIGHT(LEFT(TABLE_NAME,len(TABLE_NAME)-2),len(TABLE_NAME)-3)
	FROM #MyTempTable
