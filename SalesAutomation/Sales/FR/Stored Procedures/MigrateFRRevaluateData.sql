...
THEN INSERT ([ProductId],[StoreId],[EventDate],[Number],[ValueCostPrice],[CorrectedBy],[ReasonCode]) VALUES (s.[ProductId],s.StoreId,s.EventDate,s.[KészletMennyiség],s.[ÉrtékOnktgAron],s.[Corrected by],s.[Reason code]);
