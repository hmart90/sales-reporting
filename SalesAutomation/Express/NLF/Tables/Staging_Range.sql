CREATE TABLE [NLF].[Staging_Range] (
    ...
    [fogyár]                                    FLOAT (53)     NULL,
    CONSTRAINT [PK_Staging_Range] PRIMARY KEY CLUSTERED ([Staging_RangeId] ASC),
    CONSTRAINT [FK_Staging_Range_dbo_FileLoad] FOREIGN KEY ([FileLoadId]) REFERENCES [dbo].[FileLoad] ([FileLoadId])
);


GO
CREATE NONCLUSTERED INDEX [IX_NLF_Staging_Range_FileLoadId]
    ON [NLF].[Staging_Range]([FileLoadId] ASC);
