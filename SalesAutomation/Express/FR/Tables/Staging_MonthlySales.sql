CREATE TABLE [FR].[Staging_MonthlySales] (
    [Staging_MonthlySalesId]       INT            IDENTITY (1, 1) NOT NULL,
    ...
    [Dátum]                        DATE           NOT NULL,
    [Site]                         INT            NOT NULL,
    PRIMARY KEY CLUSTERED ([Staging_MonthlySalesId] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IX_FR_Staging_MonthlySales_FileLoadId]
    ON [FR].[Staging_MonthlySales]([FileLoadId] ASC);
